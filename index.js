...
const thumbnailBucket = process.env.THUMBNAIL_BUCKET ? process.env.THUMBNAIL_BUCKET : 'showimages1116';
...
exports.handler = (event, context, callback) => {
  ...
  // console.log('s3Bucket=%s\nkey=%s',s3Bucket,event.object.key);
  // Object key may have spaces or unicode non-ASCII characters.
  // console.log('key='+event.object.key);
